<?php 
    ...
    if(isset($_GET['f'])){
        ...
        if(CheckFunctionInput($function, $data)){
            $url = "https://wikimedia.org/api/rest_v1/media/math/render/png/".$data;
            $urlsvg = "https://wikimedia.org/api/rest_v1/media/math/render/svg/".$data;
            $hash = $data;
        }else{
            $error = true;
        }
...
<body>
    ...
    <content>
        ...
        <form method="get" target="_self">
            ...
            <input type="text" name="f" value="<?php echo $_GET['f']; ?>"/>
            <input type="submit" />
        </form>
        <?php }else{ ?>        
        <form method="get" target="_self">
            <input type="text" name="f" placholder="x^2"/>
            <input type="submit" />
